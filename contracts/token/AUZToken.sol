...
contract AUZToken is Initializable, PausableUpgradeable, LERC20Upgradeable {
    ...
    event FeeWalletUpdated(address _feeWallet);
    event SeilingWalletUpdated(address _sellingWallet);
    event AllowedContractUpdated(address _contract, bool _isAllowed);
    event FreeOfFeeContractUpdated(address _contract, bool _isFree);
    ...
    function updateSellingWallet(address _sellingWallet) public onlyOwner {
        ...
        emit SeilingWalletUpdated(_sellingWallet);
    }
